...
public class BlackListedDomainCheck : IEmailValidationChecker
{
    ...
    public BlackListedDomainCheck(IConnectionMultiplexer redis,
    ...
    public string Name => CheckNames.BlackListedDomain;
    public async Task<EmailValidationChecksInfo> EmailCheckValidator(RecordsTemplate records, EmailValidationCheck Check)
    {
        ...
        string Key = ConstantKeys.BlacklistedDomains;
